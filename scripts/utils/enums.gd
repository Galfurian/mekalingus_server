...
static func get_stat_key(stat_type: int) -> String:
	match stat_type:
		...
		StatType.MAX_POWER:
			return "max_power"
		StatType.HEALTH_GENERATION:
			return "health_generation"
		StatType.ARMOR_GENERATION:
			return "armor_generation"
		StatType.SHIELD_GENERATION:
			return "shield_generation"
		StatType.POWER_GENERATION:
			return "power_generation"
		StatType.SPEED:
			return "speed"
		StatType.SENSOR_RANGE:
			return "sensor_range"
...
static func get_stat_from_key(stat_key: String) -> int:
